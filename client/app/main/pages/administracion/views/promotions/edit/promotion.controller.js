(function () {
  ...
  /** @ngInject */
  function PromotionEditController($mdDialog, $state, Auth, Promotion, Countries,
    PromotionService, Categories) {
    var vm = this;

    // Data
    vm.currentUser = Auth.getCurrentUser;
    vm.promotion = Promotion.data;
    ...
    function savePromotion(){
      ...
      PromotionService.update(vm.promotion).then(function(res){
        if(res._id){
          showMessageOk({
